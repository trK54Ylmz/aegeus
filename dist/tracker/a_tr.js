 ...
 *
 * @param p {string} Query parameter name
 * @returns {string|null}
 */
_agt.qp = function (p) {
    if (!p) {
 ...
 * @returns boolean
 */
_agt.sck = function (k, v, t, p, d, iss) {
 ...
 * @type {string}
 */
_agt.ascii = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
...
/**
 * Get timezone name by offset name
 *
 * @param ofs {Number}
 * @returns {string|null}
 */
_agt.tzofs = function (ofs) {
    var ofsl = {
        '-720,0': 'Etc/GMT+12',
